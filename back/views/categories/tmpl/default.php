...
<div id="editcell">
	...
	<thead>
		<tr>
			...
			<th class="title">
				<?php echo JHTML::_('grid.sort',  'Parent Categories', 'c.parent_id', $this->lists['order_Dir'], $this->lists['order'] ); ?>
			</th>
	...
	{
		$row = &$this->items[$i];
		$link 	= JRoute::_( 'index.php?option=com_webmapplus&controller=category&task=edit&cid[]='. $row->id );
